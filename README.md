...
- **Branş landing sayfaları:** [`public/rehber/`](public/rehber/) — Firebase Hosting’de dosya olarak sunulur (SPA rewrite’undan önce). Güncellemek için `npm run generate:rehber` (`scripts/generate-rehber-pages.mjs`).
