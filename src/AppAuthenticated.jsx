...
import { PublicHome } from "./components/seo/PublicSeoPages";
...
// Auth + firebase'e bağlı asıl uygulama. SADECE /giris, /app, dashboard veya
// kullanıcı giriş butonuna tıkladığında lazy-load edilir (bkz. App.jsx).
// Public SEO route'ları (PublicHome, SeoLandingPage) bu modülü hiç yüklemez,
// böylece Firebase Auth SDK'sı/iframe'i o sayfalarda çalışmaz.
export default function AppAuthenticated() {
  ...
  //   "/"        → girişli kullanıcıya uygulama, anonime PublicHome
