    ...
    <div className="fixed inset-0 z-50 bg-slate-950/80 p-4 flex items-center justify-center">
      <div className="w-full max-w-md rounded-3xl border border-slate-700 bg-slate-900 p-6">
        ...
        <p className="text-xs text-slate-400 mb-5 font-medium">
          Hedef kullanıcı: {user.displayName || user.email || user.id}
        </p>
        ...
        <textarea
          ...
          rows={6}
          className="w-full mb-5 px-3 py-2 rounded-xl bg-slate-950 border border-slate-700 text-white text-sm font-medium"
          placeholder="Kullanıcıya özel admin notu"
        />
