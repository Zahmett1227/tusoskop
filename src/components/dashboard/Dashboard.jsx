...
const Dashboard = ({ SUBJECTS, QUESTIONS, startSubject, setView, startFullExam }) => {
...
>
  <span className="relative z-10 flex items-center justify-center gap-3">
    ...
    <div className="flex w-full flex-col gap-3 sm:flex-row lg:w-auto lg:flex-col">
      <button
        ...
        "
      >
        <span className="absolute inset-0 bg-[linear-gradient(120deg,transparent,rgba(255,255,255,0.14),transparent)] -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
        <span className="relative z-10 flex items-center justify-center gap-3">
          <span className="text-lg">📚</span>
  ...
  <p className="text-sm md:text-base text-emerald-300/90 font-medium text-center">
    İstediğin ders ve konudan hızlı test başlat, konularını takip et, çalışma düzenini güçlendir.
  </p>
</div>
